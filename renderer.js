const openFilesBtn = document.getElementById('loadbtn');
...
const createWebpBtn = document.getElementById('create-webp-btn');
...
createWebpBtn.addEventListener('click', async () => {
    try {
        ...
        const filePath = await window.api.saveWebP(filePaths, frameDelay);
